...
$islamicQuestions3 = @"
                    ,
                    { q: "Which Surah of the Quran was the first to be revealed completely?", options: ["Surah Fatiha", "Surah Ikhlas", "Surah Muddathir", "Surah Alaq"], answer: 0, explanation: "Surah Al-Fatiha was the first complete chapter revealed to the Prophet." },
                    { q: "What was the real name of Abu Jahl?", options: ["Amr bin Hisham", "Utbah bin Rabi'ah", "Waleed bin Mughira", "Umayyah bin Khalaf"], answer: 0, explanation: "His real name was Amr ibn Hisham; the Muslims called him Abu Jahl (Father of Ignorance)." },
                    { q: "In the Battle of Uhud, who commanded the Muslim archers?", options: ["Hazrat Hamza (RA)", "Hazrat Ali (RA)", "Hazrat Abdullah bin Jubair (RA)", "Hazrat Khalid bin Waleed (RA)"], answer: 2, explanation: "He led the 50 archers stationed on the mount to protect the rear." },
                    { q: "How many times does the word 'Allah' appear in the Holy Quran?", options: ["2584", "2698", "2750", "2800"], answer: 1, explanation: "The exact word 'Allah' appears 2,698 times." },
                    { q: "Which angel is tasked with blowing the soul into the fetus?", options: ["Jibraeel (AS)", "Mikaeel (AS)", "Israfeel (AS)", "A specially appointed angel"], answer: 3, explanation: "A specific angel is sent to breathe the soul into the womb at 120 days." },
                    { q: "What was the name of the monk who recognized the Prophethood of Muhammad (PBUH) in Syria?", options: ["Waraqah bin Naufal", "Bahira", "Salman Farsi", "Najashi"], answer: 1, explanation: "Bahira the Christian monk saw the signs of prophethood during a trade journey." },
                    { q: "For how many years did the Holy Prophet (PBUH) preach Islam in Mecca before migration?", options: ["10 years", "12 years", "13 years", "15 years"], answer: 2, explanation: "He preached in Mecca for 13 years before migrating to Medina." },
                    { q: "Which wife of the Prophet (PBUH) narrated the most Hadiths?", options: ["Hazrat Khadija (RA)", "Hazrat Hafsa (RA)", "Hazrat Ayesha (RA)", "Hazrat Umm Salama (RA)"], answer: 2, explanation: "Hazrat Ayesha (RA) narrated 2,210 Hadiths." },
                    { q: "What is the penalty for stealing (Sariqah) in Islamic Law, subject to strict conditions?", options: ["Imprisonment", "Flogging", "Amputation of the hand", "Fine"], answer: 2, explanation: "Classical Sharia prescribes the cutting of the hand under rigid evidentiary standards." },
                    { q: "Who was the maternal grandfather of Prophet Muhammad (PBUH)?", options: ["Abdul Mutalib", "Wahb ibn Abd Manaf", "Hashim", "Asad ibn Hashim"], answer: 1, explanation: "Wahb was the father of Hazrat Aminah." },
                    ...
                    { q: "Who was the 'Zul-Qarnain' mentioned in Surah Al-Kahf?", options: ["Alexander the Great", "Cyrus the Great", "A righteous king", "Opinions differ (All of the above)"], answer: 3, explanation: "Scholars have debated his identity; many associate him with Cyrus the Great or a righteous ancient ruler." },
                    ...
                    { q: "The treaty of Versailles... wait, in Islamic history, what was the first mosque built by the Prophet?", options: ["Masjid-e-Nabawi", "Masjid-e-Quba", "Masjid-e-Aqsa", "Masjid-e-Haram"], answer: 1, explanation: "Masjid-e-Quba was the first mosque built upon arriving in Medina." }
"@
...
for ($i = 0; $i -lt $lines.Count; $i++) {
    ...
    if ($inIslamic -and -not $islamicInserted -and $line -match '\]\s*$') {
        ...
        $updatedLines += $islamicQuestions3
...
Write-Host "Injected 50 more Islamic Studies questions (Total 150)."
